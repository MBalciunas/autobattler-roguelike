...
public partial class QuickJab : Ability
{
    ...
    protected override void ExecuteAbility()
    {
        ...
        effect.Init((stats.damage, stats.goldOnKillChance));
        ...
        effect.Scale = new Vector2(0.1f, 1f); // Start small in the extending direction
        ...
        tween.TweenProperty(effect, "scale", new Vector2(1f, 1f), 0.08f)
